...
public class PrimerPrograma{
     ...
     public static void main(String[] args){
	  ...
	  // con checkbox group estan organizados como grupo 
          // y sólo se puede seleccionar uno de ellos
          CheckboxGroup cbg = new CheckboxGroup();
          Checkbox cb1 = new Checkbox ("Mostrar subdirectorios", cbg , false);
          Checkbox cb2 = new Checkbox ("Mostrar carpetas", cbg, false);
